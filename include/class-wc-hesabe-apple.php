...
class WC_Hesabe_ApplePay extends WC_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->id = 'hesabe_apple';
        $this->method_title = __('Apple Pay Online Payment');
        $this->icon = WP_PLUGIN_URL . "/" . plugin_basename(__DIR__) . '/images/apple.png';
    ...
    function init_form_fields()
    {
        ...
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type' => 'checkbox',
                'label' => __('Enable Hesabe Apple Pay Online Payment Module.'),
                'default' => 'no'),
            ...
            'title' => array(
                ...
                'default' => __('Apple Pay Online Payment via Hesabe')),
